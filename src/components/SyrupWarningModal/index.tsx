...
import { Button, Text } from '@kreamswap-libs/uikit'
            ...
            <>
              ...
              <Text color="failure">
                {transactionType === 'Buying'
                  ? 'You will not receive KREAM rewards for holding purchased SYRUP.'
                  : 'You will need to buy back the same amount of SYRUP to be able to convert back to KREAM.'}
              </Text>
            </>
          )}
          <RowBetween>
